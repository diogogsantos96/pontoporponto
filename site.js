...
const I18N = {
  pt: {
    ...
    'process.s2.desc': 'Cortado à medida, todas as estações.',
  ...
  en: {
    ...
    'process.s2.desc': 'Cut to size, every season.',
  ...
  es: {
    ...
    'process.s2.desc': 'Cortado a medida, cada temporada.',
  ...
  it: {
    ...
    'process.s2.desc': 'Tagliato su misura, ogni stagione.',
